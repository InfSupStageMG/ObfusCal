...
| Component                      | Responsibility                                                                                                                                                                                       |
|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `CalendarOwnersController`     | `GET /me`, `GET /{id}/busy-slots`, `GET /{id}/merged-freebusy`, `GET/PUT /{id}/obfuscation-profiles`, `GET /{id}/calendar/providers`, `PUT /{id}/calendar/provider`, `GET/POST /{id}/calendar/status |consent`. Enforces Entra ID auth and per-owner scoping. |
