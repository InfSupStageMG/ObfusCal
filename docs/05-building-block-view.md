...
| Component                                    | Responsibility                                                                                                                                                                                                                                                                                                  |
|----------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `MockCalendarSource`                         | Development adapter returning hardcoded events anchored to today. Plugin ID: `mock`.                                                                                                                                                                                                                            |
| `GraphCalendarSource`                        | Production adapter fetching Outlook / Microsoft 365 events via Microsoft Graph. Plugin ID: `graph`.                                                                                                                                                                                                             |
...
| `CalendarOwnerAvailabilityBackgroundService` | Periodically triggers the local availability snapshot cycle (writes `CalendarOwnerAvailabilitySlot` records).                                                                                                                                                                                                   |
...
| Component                                    | Responsibility                                                                                                                                                                                                                                                                                                                                                                           |
|----------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `CalendarOwnersController`                   | `GET /me`, `GET /{id}/busy-slots`, `GET /{id}/merged-freebusy`, `GET /{id}/calendar/providers`, `GET/POST /{id}/calendar/sources`, `PATCH/DELETE /{id}/calendar/sources/{sourceId}`, `PUT /{id}/calendar/provider`, consent initiation and callback. Enforces Entra ID auth and per-owner scoping.                                                                                       |
...
classDiagram
    ...
    class BusySlot {
        <<domain record - never persisted with Id/PeerId>>
