...
| TD-02 | No HTTPS termination in the container                           | Reverse proxy (nginx / Traefik) is the correct production pattern; out of scope for PoC | Add nginx or Traefik sidecar configuration in the deployment sprint                         |
