...
We needed a test framework that aligns with Info Support's internal standards and supports integration testing against
...
MSTest aligns with Microsoft and Info Support company standards. Testcontainers allows integration tests to spin up
...
* **Positive:** Aligned with Info Support tooling standards.
