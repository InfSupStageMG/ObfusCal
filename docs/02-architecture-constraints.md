...
| .NET 10 (C#)                                                   | Primary language chosen for team expertise and Info Support in-house knowledge.                                                                                                      |
...
| Info Support development standards | ADRs follow the Info Support guidance framework. Testing uses MSTest per company standard.                  |
...
| Decision records  | ADR format per Info Support guidance, stored in `docs/adr/` |
