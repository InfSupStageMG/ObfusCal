...
| `graph-instance-consent-readonly` | Calls `ICalendarOwnerGraphConsentService.BuildAuthorizationUrlAsync` to start Outlook read-only consent for the instance and navigates to the returned URL  |
| `graph-instance-consent`          | Calls `ICalendarOwnerGraphConsentService.BuildAuthorizationUrlAsync` to start Outlook write-back consent for the instance and navigates to the returned URL |
