...
public sealed class GraphConsentOptions
{
    ...
    public string ReadOnlyScope { get; init; } = "https://graph.microsoft.com/Calendars.Read offline_access";
    public string ReadWriteScope { get; init; } = "https://graph.microsoft.com/Calendars.ReadWrite offline_access";
    public string Scope { get; init; } = "https://graph.microsoft.com/Calendars.ReadWrite offline_access";
    public string? AuthorityTenant { get; init; }
